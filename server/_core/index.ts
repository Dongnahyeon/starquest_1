...
// Generate web app HTML if it doesn't exist
function ensureWebAppHTML(webPath: string) {
  const indexPath = path.join(webPath, 'index.html');
  
  if (!fs.existsSync(indexPath)) {
    console.log('[web] Generating index.html...');
...
<body>
  ...
  <script>
    ...
    console.log('[web] ✅ index.html generated successfully');
  }
}
...
async function startServer() {
  ...
  // Ensure web app HTML exists
  ensureWebAppHTML(webPath);
